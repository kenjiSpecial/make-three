...
function makeCircleGeometry(params){
...
function makeLine(maxNum, gpuComputeSize){
    let uvs = [];
    let customUvs = [];
    let xx, yy;
...
function makeCircleLine(divideNum){
    divideNum = divideNum ? divideNum : 36;
    let uvs = [];
    let positions = [];
...
function makeOutlineGeometry(lineNum){
    lineNum = lineNum ? lineNum : 100;
    let positions = [];
    let indexArray = [];
    let customUvs = [];
    let thetas = [];
...
function makeGPGPUGeometry(gpuComputeSize){
